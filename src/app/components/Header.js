        ...
        >
          ...
          <div className={`absolute left-0 mt-2 w-56 bg-gray-900/95 backdrop-blur-lg border border-gray-800 rounded-lg shadow-2xl transition-opacity duration-200 ${
            ...
            <ul className="py-2">
              ...
              <li className="px-4 py-2 hover:bg-gray-800/50 transition-colors">
                <Link href="/fortalent/talent-support极" className={`block ${isActive('/fortalent/talent-support') ? 'text-blue-500 glow-blue' : 'text-gray-300 hover:text-white'}`}>Talent support</Link>
              </li>
            </ul>
          </div>
        </div>
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-16 left-0 right-0 bg-gray-900 rounded-lg shadow-lg z-50">
          <ul className="flex flex-col items-center py-2">
            ...
            <li className="px-4 py-2 hover:bg-gray-800/50 transition-colors">
              <Link href="/contact" className={`block ${isActive('/contact') ? 'text-blue-500 glow-blue' : 'text-gray-300 hover:text-white'}`}>Contact</Link>
            </li>
          </ul>
        </div>
      )}
