      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex space-x-4 ">
          ...
          <Link href="https://twitter.com" target="_blank" rel="noopener noreferrer">
            <a class="transition-colors duration-200" href="https://x.com" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
          ...
          <Link href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer">
            <a class="transition-colors duration-200" href="https://www.linkedin.com" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" class="h-4.5 w-4.5 translate-y-0 opacity-80 transition-opacity duration-300 hover:opacity-100">
            ...
            <img src="/facebook-icon.png" alt="LinkedIn" className="w-6 h-6" />
          </Link>
          {/* instagram logo */}
          
          {/* youtube logo */}
          <Link href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">
            <a class="transition-colors duration-200" href="https://www.youtube.com" aria-label="Youtube" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18" class="h-4.5 w-4.5 translate-y-0 opacity-80 transition-opacity duration-300 hover:opacity-100">
            ...
            <img src="/facebook-icon.png" alt="YouTube" className="w-6 h-6" />
          </Link>
        </div>
